...
Clinique la Merveille <span style="margin-left: 450px">{{$dat}}</span>
                        </h4>
                    ...
                    <div class="table-responsive m-t-40">
                        <table  class="table display table-bordered table-striped">
                            ...
                            <tr>
                                ...
                                @foreach($prescrie as $prescrie)

                  <td>{{$prescrie->quantite}}</td>
              <td >{{$prescrie->nom_prod}} </td>
                ...
                <div style="margin-left: 250px; font-family: 'MS Gothic';font-size: 25px;color: blue"> Bonne guérison!!!!!! 
  </div>
