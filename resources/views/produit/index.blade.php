                    ...
                    <div class="card card-outline-info">
                        ...
                        <div class="card-body">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">Listes Produits!</h4>
                            </div>
                            <div class="table-responsive m-t-40">
                                <table id="example23" class="table display table-bordered table-striped">
                                    ...
                                    @foreach($produits as $produit )
                                        <tr>
                                            <td> <form action="{{route('produit.destroy',$produit)}} "
                                                       method="POST"
                                            ...
                                            <td><a href="{{route('produit.edit',$produit)}}"><button type="submit" ><i class="fa fa-pencil "></i> </button>  </a></td>
                                            <td>{{$produit->id}}</td>
