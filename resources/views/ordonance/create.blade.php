...
<div class="container" style="margin-top: 80px">
    <h1 class="text-blue text-center font-weight-bold">Etablir une ordonnance</h1>
</div>
    ...
    <div class="col-12">
        ...
        <div class="card card-outline-info">
            ...
            <div class="card-body">
                ...
                <div class="table-responsive m-t-40">
                  ...
                  <form action="{{route('ordonance.store')}}" method="POST">
                               {{csrf_field()}}
                                ...
                                <td>
                                    <span class="text-blue font-weight-bold">{{$patient->created_at}}</span>
                                </td>
                ...
                <td><button type="submit" class="btn btn-info" >ordonance</button></td>
            </form>
                        </tr>
                        @endforeach
                        </tbody>
