        ...
        <div class="col-md-11 align-center">
            <div class="row">
                <div class="card card-outline-info">
                    ...
                    <div class="card-body">
                        <form action="{{route('ordonance.update',$ordonance)}}" method="POST">
                            {{csrf_field()}}
                            {{method_field('PUT')}}
                            <div class="form-body">
                                ...
                                <div class="row p-t-20">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <label>Quantité</label>
                                                ...
                                                <select type="text" value="{{$ordonance->quantite}}" name="qte" class="form-control" required >
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group ">
                                            ...
                                            <input type="text" value="{{$ordonance->posologie}}" name="poso"  id="qte"  class="form-control" required maxlength="150">
                                        </div>
                                        <!--/span-->
                                    </div>
                                    <!--/span-->
